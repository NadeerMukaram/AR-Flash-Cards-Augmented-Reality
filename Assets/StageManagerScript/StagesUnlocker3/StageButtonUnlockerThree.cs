...
public class StageButtonUnlockerThree : MonoBehaviour
{
    public bool[] stageIsUnlocked; // Change this based on your game logic
    private const string unlockKeyPrefix = "StageUnlockedThree_"; // PlayerPrefs key prefix for stage unlock status
